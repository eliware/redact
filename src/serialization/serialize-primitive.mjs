...
export function serializePrimitive(value, maxString) {
  ...
  if (value === undefined)
    return { handled: true, value: serializeUndefined() };
  if (typeof value === "string")
    return { handled: true, value: enforceStringLimit(value, maxString) };
  if (typeof value === "bigint")
    return { handled: true, value: serializeBigInt(value) };
  if (typeof value === "function")
    return { handled: true, value: serializeFunction(value) };
  if (typeof value === "symbol")
    return { handled: true, value: serializeSymbol(value) };
